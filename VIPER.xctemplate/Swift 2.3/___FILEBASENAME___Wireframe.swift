...
class ___VARIABLE_productName___Wireframe {
        ...
        lazy var moduleNavigationController: UINavigationController = {
                ...
                let nc = (sb.instantiateViewControllerWithIdentifier(___VARIABLE_productName___Constants.navigationControllerIdentifier) as? UINavigationController)!
                return nc
        }()
        */
        ...
        lazy var moduleView: ___VARIABLE_productName___View = {
                ...
                let sb = ___VARIABLE_productName___Wireframe.storyboard()
                let vc = (sb.instantiateViewControllerWithIdentifier(___VARIABLE_productName___Constants.viewIdentifier) as? ___VARIABLE_productName___View)!
                let _ = vc.view
                return vc
        }()
    	...
    	class func storyboard() -> UIStoryboard {
                return UIStoryboard(name: ___VARIABLE_productName___Constants.storyboardIdentifier,
                                    bundle: NSBundle(forClass: ___VARIABLE_productName___Wireframe.self))
    	}
